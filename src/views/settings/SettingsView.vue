<template>
    <a-modal v-model:open="isModalOpen" :title="$t('settings')" @ok="handleOk" @cancel="handleCancel" width="600px">
...
// Theo dõi sự thay đổi từ props để cập nhật modal
...
// Đóng modal khi click Ok hoặc Cancel
const handleOk = () => {
