  ...
  <div class="flex justify-center items-center h-[100vh]">
    ...
    >
      <div class="hidden bg-cover lg:block lg:w-1/2 mx-auto my-auto">
        <img
          src="../../assets/images/login-calendar-cuate_1-removebg-preview.png"
          alt=""
        />
      </div>
      ...
      >
        <h2 class="mt-3 text-4xl font-bold text-gray-600">Login</h2>
        ...
        <a-form-item
          label="Email"
          name="email"
          class="mt-4 block mb-2 text-sm font-medium text-gray-600"
          for="email"
        >
          <a-input
        ...
        <div class="flex justify-end">
          <router-link
            to="/forgot-password"
            class="underline decoration-orange-300 text-xs font-medium text-gray-500 hover:underline"
        ...
        <div class="flex items-center justify-center flex-col gap-4 mt-4">
          <router-link
            to="/register"
            class="underline decoration-orange-300 text-sm text-gray-500 hover:underline"
    ...
    <div class="absolute bottom-4">
      <p class="block m-0 text-sm leading-10 text-gray-600">
        ...
        <router-link
          to="/"
          class="text-sm text-gray-500 font-medium underline decoration-orange-300 transform hover:text-orange-300"
